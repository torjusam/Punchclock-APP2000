// Taken from:https://github.com/undrash/next.js-api-middleware/blob/main/demo-api-routes/src/pages/middleware/handler.ts
// This is a middleware handler that allows you to chain multiple middleware functions together.
